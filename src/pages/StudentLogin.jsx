...
import { LogIn, GraduationCap, Eye, EyeOff, Mail, Lock, ArrowLeft, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/student-signup" className="font-semibold text-blue-600 hover:text-blue-500 transition-colors">
              Sign up here
            </Link>
          </p>
        </div>
